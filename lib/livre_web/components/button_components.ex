defmodule LivreWeb.ButtonComponents do
  ...
  def google_login(assigns) do
    ...
    <button
      ...
      class={[
        generic_class(),
        "font-light w-56 max-w-56 text-zinc-900 dark:text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
      ]}
    >
      <svg
