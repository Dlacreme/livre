defmodule LivreWeb.FormComponents do
  ...
  ## Examples
      ...
      <Form.simple for={@form} phx-change="validate" phx-submit="save">
        <.input field={@form[:email]} label="Email"/>
        <.input field={@form[:username]} label="Username" />
        <:actions>
          <Button.simple>Save</Button.simple>
        </:actions>
      </Form.simple>
  """
  ...
  def simple(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      ...
      <div :for={action <- @actions} class="m-4 flex justify-end gap-6">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivreWeb.Gettext, "errors", msg, opts)
    end
  end
